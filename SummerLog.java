package com.hcl;
public class SummerLog implements Comparable<SummerLog> {
	...
	public SummerLog(String dialledNumber, Double totalDuration, String name) {
		super();
	...
	@Override
	public int compareTo(SummerLog o) {
